...
public class PreferenceListPanel extends UiPart<Region> {
    ...
    @FXML
    private ListView<HashSet<Tag>> preferenceListView;

    /**
     * Creates a {@code PreferenceListPanel} with the given {@code ObservableList}.
     */
    public PreferenceListPanel(ObservableList<HashSet<Tag>> preferenceList) {
        super(FXML);
     ...
     */
    class PreferenceListViewCell extends ListCell<HashSet<Tag>> {
        @Override
        protected void updateItem(HashSet<Tag> preference, boolean empty) {
